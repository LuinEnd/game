...
function commands() {
	...
	if (g$cm.value.match("/avatar")) {
		g$pi.style.backgroundImage = "url(../Resources/" + g$cm.value.slice(8, 18) + ".png)"
	}
	...
	if (g$cm.value.match("/rgb")) {
		g$sb.style.animation = "RGB 10s infinite ease"
	}
